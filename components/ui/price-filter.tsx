...
import SliderTemplate from "../templates/slider-template";
...
export const PriceFilter = React.forwardRef<MultiSelectRef, MultiSelectProps>(
	(
		{
			options,
			onValueChange,
					...
					<PopoverContent
						...
						<Command>
							...
							<div className="flex flex-col m-2">
								...
								<SliderTemplate min={0} max={10000} step={100} />
								</div>
								
								<div className="flex items-center justify-between">
									<ButtonTemplate title="Min price" className="bg-white text-[#4D5061] border text-sm font-normal hover:bg-white"/>
									<ButtonTemplate title="Max price" className="bg-white text-[#4D5061] border text-sm font-normal hover:bg-white" />
...
PriceFilter.displayName = "MultiSelect";
