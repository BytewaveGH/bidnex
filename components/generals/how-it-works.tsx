  ...
  return (
    <div>
        ...
        <div className="relative max-w-6xl mx-auto">
          {/* Horizontal connecting line — hidden on mobile, visible on sm+ */}
          <div className="hidden sm:block absolute top-8 left-40 right-40 h-0.5 bg-gray-300"></div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-0 relative">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-[#96A4B1] text-sm leading-relaxed">Sign up for free and verify your account to start bidding</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-[#96A4B1] text-sm leading-relaxed">Explore thousands of items and place your bids</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-[#96A4B1] text-sm leading-relaxed">Be the highest bidder when the timer runs out</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-[#96A4B1] text-sm leading-relaxed">Complete payment and get your item delivered</p>
              </div>
            </div>
          </div>
        </div>
