...
import { useVendorSignup } from '../_logics/useSignup'

export default function VendorSignupForm({ onChangePage }: { onChangePage: (phone: string) => void }) {
    const {
        formData,
        updateField,
        showPassword,
        ...
        <div className="px-6 py-12">
            <div className="mb-8">
                ...
                <p className="text-base text-[#657688] font-normal">
                    ...
                    <Link href="/vendor/auth/login" className="text-base text-[#13161A] font-normal">
                        Sign In
                    </Link>
                </p>
            </div>
