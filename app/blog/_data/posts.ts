...
export const blogPosts: BlogPost[] = [
    {
        ...
        title: 'Max Bids Explained: Let BIDNEX Bid For You',
        excerpt:
            "Tired of refreshing the page every few minutes to defend your lead? Here's exactly how setting a max bid lets BIDNEX compete on your behalf — automatically, and only when it needs to.",
        ...
        featured: true,
        content: [
            "Every serious bidder has been there: you place a bid, close the tab, and by the time you check back someone has outbid you by a few cedis and the auction has moved on. Max Bid exists to remove that anxiety entirely. Instead of placing one bid at a time, you tell BIDNEX the absolute most you're willing to pay for a lot, and the system bids on your behalf in small increments — just enough to keep you in the lead, and never more than you approved.",
            "Here's the mechanic in plain terms: say the current bid on a lot is GHS 200 and the increment is GHS 20. If you set a max bid of GHS 400, BIDNEX places GHS 220 for you right away. If another bidder comes in at GHS 260, the system automatically raises you to GHS 280 — still comfortably under your cap. You only get outbid once someone's true ceiling is higher than yours, and even then you'll know immediately because your card flips from a green WINNING ribbon to an amber OUTBID one.",
        ...
        callout: {
            ...
            body: 'Add a lot to your Watchlist, set a max bid before the final hour, and let BIDNEX handle the back-and-forth while you do literally anything else.',
        },
    },
    {
    ...
    },
    {
        ...
        excerpt:
            "Electronics move fast on BIDNEX. Here's how to separate an actual bargain from a lot you'll regret winning.",
        category: 'Buying Guide',
        coverImage:
        ...
        content: [
            ...
            "Compare the market price to what the same item sells for new elsewhere. BIDNEX shows an MKT PR reference on every card specifically so you're never bidding blind — if a lot's current bid is already close to that figure, factor in that you're paying near-retail for a used item, which only makes sense if the condition badge reads New/Like New.",
            ...
            "Remember that every purchase, whether won by bid or Buy Now, is protected by BIDNEX's escrow: your payment isn't released to the vendor until you confirm the item arrived as described. If something's materially wrong, you have 48 hours from the expected delivery date to raise a dispute — so a fair deal today is also a protected one.",
        ],
    },
    {
    ...
    },
    {
        ...
        title: 'Escrow & Safety: How BIDNEX Protects Every Transaction',
        excerpt:
            "Every cedi you spend on BIDNEX passes through an escrow step before it ever reaches a vendor. Here's exactly how that protects you.",
        ...
        readTime: '4 min read',
        content: [
            "When you win a lot or use Buy Now, your payment doesn't go straight to the vendor — it's held by BIDNEX in escrow. The vendor is notified to prepare the item for pickup or delivery, but the funds only move to them once you've confirmed the item arrived as described.",
    ...
    },
    {
        ...
        excerpt:
            "BIDNEX reaches every region in Ghana — but delivery isn't one-size-fits-all. Here's what to check before you bid.",
        category: 'Platform Updates',
        coverImage:
        ...
        readTime: '3 min read',
        content: [
            "BIDNEX itself is accessible anywhere in Ghana with an internet connection, from Accra and Kumasi to Tamale and Takoradi. What varies lot to lot is how the vendor gets the item to you — that's set individually, not platform-wide.",
    ...
    },
    {
        ...
        content: [
            ...
            "That first listing sold within its window, and the buyer left a five-star rating specifically calling out how accurately the item was described. On BIDNEX, that kind of early trust compounds: buyers browsing a vendor's other lots can see the rating before they ever place a bid.",
